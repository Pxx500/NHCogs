...
MODULE_NAMES = (
    ...
    "NHCogs.githubtickets.github_app",
    "NHCogs.githubtickets.credentials",
    "NHCogs.githubtickets.webhook",
    "NHCogs.githubtickets.events",
    "NHCogs.githubtickets.runtime",
    "NHCogs.githubtickets.event_handler",
